...
// Existing function to count books in the Firestore collection
...
// New function to add a book with capitalized title and author
exports.addBook = onRequest((req, res) => {
  cors(req, res, async () => {
    try {
      ...
      // Add the capitalized book entry to Firestore
